...
ExclusiveDoubleButton::ExclusiveDoubleButton(const QString& left_button_name,
  ...
  connect(button_group_, QOverload<QAbstractButton*, bool>::of(&QButtonGroup::buttonToggled), this, &ExclusiveDoubleButton::OnButtonToggled);
}

void ExclusiveDoubleButton::OnButtonToggled(QAbstractButton* button, bool checked) {
  if (checked) {
