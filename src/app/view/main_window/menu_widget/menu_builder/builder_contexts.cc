...
SubPanelContext::SubPanelContext(SubPanel* sub_panel, PanelContext* panel_context,
...
SubPanelContext PanelContext::AddSubPanel(const QString& title) {
  ...
  return SubPanelContext(sub_panel, this, root_builder_, item_width_, item_height_);
}
